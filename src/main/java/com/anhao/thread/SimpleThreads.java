 ...
 *
 * You can run this file with command java SimpleThreads.java [args1]
 *
 * The `SimpleThreads` class consists of two threads.
...
public class SimpleThreads {
  ...
  public static void main(String args[]) throws InterruptedException {
    ...
    threadMessage("Starting MessageLoop thread now...");
